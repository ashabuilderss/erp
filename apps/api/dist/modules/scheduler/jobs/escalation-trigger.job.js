...
var EscalationTriggerJob_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.EscalationTriggerJob = void 0;
...
let EscalationTriggerJob = EscalationTriggerJob_1 = class EscalationTriggerJob {
    prisma;
    advisoryLock;
    logger = new common_1.Logger(EscalationTriggerJob_1.name);
    constructor(prisma, advisoryLock) {
        this.prisma = prisma;
    ...
    async evaluateRule(rule) {
        ...
        const alreadyTriggered = new Set(existingEventKeys.map((e) => `${e.entityType}:${e.entityId}`));
        switch (rule.triggerType) {
            ...
            case 'ATTENDANCE_MISSED': {
                ...
                for (const emp of employees) {
                    const attendance = await this.prisma.attendanceDayAggregate.findUnique({
                        where: {
    ...
    async createEvent(rule, entityId, entityType, description) {
...
exports.EscalationTriggerJob = EscalationTriggerJob;
__decorate([
    (0, schedule_1.Cron)('*/5 * * * *'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], EscalationTriggerJob.prototype, "handle", null);
exports.EscalationTriggerJob = EscalationTriggerJob = EscalationTriggerJob_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService,
        advisory_lock_service_1.AdvisoryLockService])
], EscalationTriggerJob);
//# sourceMappingURL=escalation-trigger.job.js.map