...
import { CreateSopDto, UpdateSopDto, AcknowledgeSopDto, QuerySopDto } from './dto/create-sop.dto';
...
export declare class TrainingController {
    ...
    acknowledgeSop(companyId: string, currentEmployeeId: string, id: string, dto: AcknowledgeSopDto): Promise<{
        employee: {
            users: {
                email: string;
                firstName: string;
    ...
    listAcknowledgements(companyId: string, id: string): Promise<({
        employee: {
            users: {
                email: string;
                firstName: string;
