...
export declare class DeviceRegistrationsService {
    private readonly prisma;
    constructor(prisma: PrismaService);
    create(dto: CreateDeviceRegistrationDto, employeeId: string, companyId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        companyId: string;
    ...
    findMyDevices(employeeId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        companyId: string;
