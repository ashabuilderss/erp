...
__decorate([
    (0, swagger_1.ApiProperty)({ example: '2024-02-03' }),
    (0, class_validator_1.IsDateString)(),
    __metadata("design:type", String)
], CreateLeaveRequestDto.prototype, "endDate", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: client_1.LeaveType, default: client_1.LeaveType.MEDICAL }),
    (0, class_validator_1.IsEnum)(client_1.LeaveType),
    __metadata("design:type", String)
], CreateLeaveRequestDto.prototype, "type", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Medical emergency' }),
    (0, class_validator_1.ValidateIf)((o) => o.type === client_1.LeaveType.MEDICAL),
