...
__decorate([
    (0, class_validator_1.ValidateIf)((o) => o.status === client_1.LeadStatus.LOST),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'lostReason is required when status is LOST' }),
    __metadata("design:type", String)
], UpdateLeadStatusDto.prototype, "lostReason", void 0);
